...
public class EddyEngine {
  ...
  public void attachMetrics(com.spiron.metrics.EnergyMetrics metrics) {
    this.energyMetrics = metrics;
  }
  
  public void attachThroughputMetrics(com.spiron.metrics.ThroughputMetrics metrics) {
    this.throughputMetrics = metrics;
  }
  
  public void attachStorageMetrics(com.spiron.metrics.StorageMetrics metrics) {
